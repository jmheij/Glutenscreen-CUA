...
spec_POCT <- expit(spec_POCT)
  ...
  probability_late_diagnosis_children <- 1 - (1-p_diag_children)^(1/18) 
 ...
 ## Developing Osteoporosis (Osteoporosis probabilities On GFD)
  ...
  # **ADAPTED**
    log_or_osteoporosis_GFD <- rnorm(n_samples, mean = log(
                                                          (((tp_asymp/subgroup_all)*1+(tp_symp/subgroup_all)*1.43)+
                                                                    ((tp_asymp/(subgroup_all+p_diag_ever_tmp))*1+((tp_symp+p_diag_ever_tmp)/(subgroup_all+p_diag_ever_tmp))*1.43))/2),
  ...
  log_or_osteoporosis_noGFD <- rnorm(n_samples, mean = log(
                                      (((asymp_fn/fn_subgroup)*1+(symp_fn/fn_subgroup)*1.77)+
                                                                    ((asymp_fn/(fn_subgroup-p_diag_ever_tmp))*1+(p_diag_ever_tmp2/(fn_subgroup-p_diag_ever_tmp))*1.77))/2),
...
##developing NHL
 ...
 log_rr_NHL_GFD <- rnorm(n_samples, mean = log(
    (((tp_asymp/subgroup_all)*1+(tp_symp/subgroup_all)*3.28)+
                                  ((tp_asymp/(subgroup_all+p_diag_ever_tmp))*1+((tp_symp+p_diag_ever_tmp)/(subgroup_all+p_diag_ever_tmp))*3.28))/2),
 ...
 # **ADAPTED**
   log_rr_NHL_noGFD <- rnorm(n_samples, mean = log(
                                  (((asymp_fn/fn_subgroup)*1+(symp_fn/fn_subgroup)*4.7)+
                                  ((asymp_fn/(fn_subgroup-p_diag_ever_tmp))*1+(p_diag_ever_tmp2/(fn_subgroup-p_diag_ever_tmp))*4.7))/2),
 ...
 ##developing GIC 
  ...
  log_rr_GIC_GFD <- rnorm(n_samples, mean = log(
                                  (((tp_asymp/subgroup_all)*1+(tp_symp/subgroup_all)*1.32)+
                                  ((tp_asymp/(subgroup_all+p_diag_ever_tmp))*1+((tp_symp+p_diag_ever_tmp)/(subgroup_all+p_diag_ever_tmp))*1.32))/2),
  ...
  log_rr_GIC_noGFD <- rnorm(n_samples, mean = log(
                                  (((asymp_fn/fn_subgroup)*1+(symp_fn/fn_subgroup)*2.33)+
                                  ((asymp_fn/(fn_subgroup-p_diag_ever_tmp))*1+(p_diag_ever_tmp2/(fn_subgroup-p_diag_ever_tmp))*2.33))/2),
 ...
 # Log rates in general population
  ...
  # **ADAPTED**
  utility_GFD_adults <- (((tp_asymp/subgroup_all)*0.866+(tp_symp/subgroup_all)*0.84)+
                                                      ((tp_asymp/(subgroup_all+p_diag_ever_tmp))*0.866+((tp_symp+p_diag_ever_tmp)/(subgroup_all+p_diag_ever_tmp))*0.84))/2 # 0.83 is from NCV data
  utility_GFdse_adults <- (((tp_asymp/subgroup_all)*0+(tp_symp/subgroup_all)*0.001)+
                                                        ((tp_asymp/(subgroup_all+p_diag_ever_tmp))*0+((tp_symp+p_diag_ever_tmp)/(subgroup_all+p_diag_ever_tmp))*0.001))/2 # 0.001 is from NCV data
  ...
  # **ADAPTED**
  utility_GFD_children <-  (((tp_asymp/subgroup_all)*0.958+(tp_symp/subgroup_all)*0.9)+
                                                         ((tp_asymp/(subgroup_all+p_diag_ever_tmp))*0.958+((tp_symp+p_diag_ever_tmp)/(subgroup_all+p_diag_ever_tmp))*0.9))/2 # 0.9 is from NCV data
  utility_GFdse_children <-  (((tp_asymp/subgroup_all)*0+(tp_symp/subgroup_all)*0.01)+
                                                           ((tp_asymp/(subgroup_all+p_diag_ever_tmp))*0+((tp_symp+p_diag_ever_tmp)/(subgroup_all+p_diag_ever_tmp))*0.01))/2 # 0.01 is from NCV data
  ...
  # **ADAPTED**
  utility_undiagnosedCD_adults <- (((asymp_fn/fn_subgroup)*0.866+(symp_fn/fn_subgroup)*0.65)+
                                                                ((asymp_fn/(fn_subgroup-p_diag_ever_tmp))*0.866+(p_diag_ever_tmp2/(fn_subgroup-p_diag_ever_tmp))*0.65))/2 # 0.65 is from NCV data
  utility_undiagnosedCD_se_adults <- (((asymp_fn/fn_subgroup)*(0.17/sqrt(953))+(symp_fn/fn_subgroup)*0.01)+
                                                                     ((asymp_fn/(fn_subgroup-p_diag_ever_tmp))*(0.17/sqrt(953))+(p_diag_ever_tmp2/(fn_subgroup-p_diag_ever_tmp))*0.01))/2 # 0.01 is from NCV data
  ...
  # **ADAPTED**
  utility_undiagnosedCD_children <- (((asymp_fn/fn_subgroup)*0.958+(symp_fn/fn_subgroup)*0.59)+
                                                                  ((asymp_fn/(fn_subgroup-p_diag_ever_tmp))*0.958+(p_diag_ever_tmp2/(fn_subgroup-p_diag_ever_tmp))*0.59))/2 # 0.59 is from NCV data  
  utility_undiagnosedCD_se_children <- (((asymp_fn/fn_subgroup)*(0.07/sqrt(26))+(symp_fn/fn_subgroup)*0.02)+
                                                                     ((asymp_fn/(fn_subgroup-p_diag_ever_tmp))*(0.07/sqrt(26))+(p_diag_ever_tmp2/(fn_subgroup-p_diag_ever_tmp))*0.02))/2 # 0.02 is from NCV data
  ...
  cost_undiagnosedCD_adults <- (((asymp_fn/fn_subgroup)*0+(symp_fn/fn_subgroup)*cost_undiagnosedCD_adults_tmp)+
                                                             ((asymp_fn/(fn_subgroup-p_diag_ever_tmp))*0+(p_diag_ever_tmp2/(fn_subgroup-p_diag_ever_tmp))*cost_undiagnosedCD_adults_tmp))/2 
  ...
  cost_undiagnosedCD_children <- (((asymp_fn/fn_subgroup)*0+(symp_fn/fn_subgroup)*cost_undiagnosedCD_children_tmp)+
                                                               ((asymp_fn/(fn_subgroup-p_diag_ever_tmp))*0+(p_diag_ever_tmp2/(fn_subgroup-p_diag_ever_tmp))*cost_undiagnosedCD_children_tmp))/2 
 ...
 #######################################################################################
  ...
  # **ADAPTED**
  cost_abs_undiagnosed_fc <- (((asymp_fn/fn_subgroup)*0+(symp_fn/fn_subgroup)*1674.57)+
                                                           ((asymp_fn/(fn_subgroup-p_diag_ever_tmp))*0+(p_diag_ever_tmp2/(fn_subgroup-p_diag_ever_tmp))*1674.57))/2
...
cost_abs_undiagnosed_fc_beta <- (cost_abs_undiagnosed_fc_se^2)/cost_abs_undiagnosed_fc  
 cost_abs_undiagnosed_fc <- rgamma(n=n_samples, shape = cost_abs_undiagnosed_fc_alpha, scale = cost_abs_undiagnosed_fc_beta)
  ...
  # **ADAPTED**
 cost_abs_diagnosed_fc <-(((tp_asymp/subgroup_all)*0+(tp_symp/subgroup_all)*332.12)+
                                ((tp_asymp/(subgroup_all+p_diag_ever_tmp))*0+((tp_symp+p_diag_ever_tmp)/(subgroup_all+p_diag_ever_tmp))*332.12))/2
