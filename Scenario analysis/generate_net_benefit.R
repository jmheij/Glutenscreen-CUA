                                 ...
                                 lambda)
{
  ...
  # tab_qalys <- as.data.frame.table(state_qalys)
  # tab_qalys <- tidyr::pivot_wider(data=tab_qalys, names_from = "Var3", values_from = "Freq")
  # writexl::write_xlsx(tab_qalys, "state_qalys_all.xlsx")
  
  state_costs <- generate_state_costs(input_parameters) 
  # tab_costs <- as.data.frame.table(state_costs)
  # tab_costs <- tidyr::pivot_wider(data=tab_costs, names_from = "Var3", values_from = "Freq")
  # writexl::write_xlsx(tab_costs, "state_costs_all.xlsx")
  ...
  #strategies 1-3 below are the competing strategies in the main analysis
  # for (i in c(1:3)) {
