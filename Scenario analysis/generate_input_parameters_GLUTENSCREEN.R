...
spec_POCT <- expit(spec_POCT)
 ...
 # Log rates in general population
  ...
  utility_undiagnosedCD_se_adults <- (((asymp_prop/undiag_all)*(0.17/sqrt(953))+(symp_undiag/undiag_all)*0.01)+
                                                                 ((asymp_prop/(undiag_all-p_diag_ever))*(0.17/sqrt(953))+(((symp_undiag-p_diag_ever)/(undiag_all-p_diag_ever))*0.01)))/2 
  ...
  utility_undiagnosedCD_se_children <- (((asymp_prop/undiag_all)*(0.07/sqrt(26))+(symp_undiag/undiag_all)*0.02) +
                                                                   ((asymp_prop/(undiag_all-p_diag_ever))*(0.07/sqrt(26))+(((symp_undiag-p_diag_ever)/(undiag_all-p_diag_ever))*0.02)))/2 
