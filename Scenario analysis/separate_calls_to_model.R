...
# The manuscript, appendix, and corresponding excel files contain more information and details on this. 
...
#we do not report time in states for the scenario analysis.
