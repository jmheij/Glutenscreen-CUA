...
generate_state_costs <- function(input_parameters) {
  ...
  for (i_cycle_tmp in 1:n_cycles) {
    ...
    #the below commented out code shows how we obtained the broken-down costs per category (exercise needs to be repeated several times manually)
    # state_costs[, i_cycle_tmp, "diagnosed no complications"] <- cost_CDGFD +
    #   (probability_IDA[, col_ref_tmp + 1] * input_parameters$cost_IDA)
    # 
    # 
    # state_costs[, i_cycle_tmp, "diagnosed osteoporosis"]  <- cost_CDGFD +
    #   (probability_IDA[,col_ref_tmp+1] * input_parameters$cost_IDA)
    # 
    # 
    # state_costs[, i_cycle_tmp, "diagnosed GIC"]  <- cost_CDGFD +
    #   (probability_IDA[, col_ref_tmp + 1] * input_parameters$cost_IDA)
    # 
    # state_costs[, i_cycle_tmp, "diagnosed NHL"] <-  cost_CDGFD +
    #   (probability_IDA[, col_ref_tmp + 1] * input_parameters$cost_IDA)


    # state_costs[, i_cycle_tmp, "diagnosed no complications"] <- 0 # input_parameters$cost_gfp # 0 # cost_abs_diagnosed_fc #
    # 
    # 
    # state_costs[, i_cycle_tmp, "diagnosed osteoporosis"]  <- input_parameters$cost_osteoporosis #input_parameters$cost_gfp #cost_abs_diagnosed_fc # 
    # 
    # 
    # state_costs[, i_cycle_tmp, "diagnosed GIC"]  <-   input_parameters$cost_GIC # input_parameters$cost_gfp #cost_abs_diagnosed_fc #
    # 
    # state_costs[, i_cycle_tmp, "diagnosed NHL"] <-  input_parameters$cost_NHL # input_parameters$cost_gfp #cost_abs_diagnosed_fc #
    ...
    # 
    # 
    #   state_costs[, i_cycle_tmp, "Undiagnosed GIC"] <-  cost_undiagnosedCD +
    #   (probability_late_diagnosis * cost_diagnosis_ns) +
    #   (probability_IDA[, col_ref_tmp + 1] * input_parameters$cost_IDA)
    # 
    # 
    # state_costs[, i_cycle_tmp, "Undiagnosed NHL"] <-   cost_undiagnosedCD +
    #   (probability_late_diagnosis * cost_diagnosis_ns) +
    #   (probability_IDA[, col_ref_tmp + 1] * input_parameters$cost_IDA)

    
    
    # state_costs[, i_cycle_tmp, "Undiagnosed no complications"] <-  0 # cost_abs_undiagnosed_fc # 0
    # 
    # 
    # state_costs[, i_cycle_tmp, "Undiagnosed osteoporosis"] <-  input_parameters$cost_osteoporosis #  0 #cost_abs_undiagnosed_fc #
    # 
    # 
    # state_costs[, i_cycle_tmp, "Undiagnosed GIC"] <-    input_parameters$cost_GIC # 0 #cost_abs_undiagnosed_fc #
    # 
    # 
    # state_costs[, i_cycle_tmp, "Undiagnosed NHL"] <-    input_parameters$cost_NHL # 0 #cost_abs_undiagnosed_fc #
