...
spec_POCT <- expit(spec_POCT)
  ...
  log_or_osteoporosis_noGFD <- rnorm(n_samples, mean = log(
    (((1+0.5*0.77)*(asymp_prop/undiag_all)+1.77*(symp_undiag/undiag_all))+
       ((asymp_prop/(undiag_all-p_diag_ever))*(1+0.5*0.77)+(((symp_undiag-p_diag_ever)/(undiag_all-p_diag_ever))*1.77)))/2), 
  ...
  log_rr_NHL_noGFD <- rnorm(n_samples, mean = log(
    (((1+0.5*3.7)*(asymp_prop/undiag_all) + 4.7*(symp_undiag/undiag_all))+
       ((asymp_prop/(undiag_all-p_diag_ever))*(1+0.5*3.7)+(((symp_undiag-p_diag_ever)/(undiag_all-p_diag_ever))*4.7)))/2),
  ...
  log_rr_GIC_noGFD <- rnorm(n_samples, mean = log(
    (((1+0.5*1.33)*(asymp_prop/undiag_all)+2.33*(symp_undiag/undiag_all))+
       ((asymp_prop/(undiag_all-p_diag_ever))*(1+0.5*1.33)+(((symp_undiag-p_diag_ever)/(undiag_all-p_diag_ever))*2.33)))/2),
  ...
  # **ADAPTED**
  utility_undiagnosedCD_adults <- (((asymp_prop/undiag_all)*((0.866+0.65)/2)+(symp_undiag/undiag_all)*0.65)+
                                                                ((asymp_prop/(undiag_all-p_diag_ever))*((0.866+0.65)/2)+(((symp_undiag-p_diag_ever)/(undiag_all-p_diag_ever))*0.65)))/2 # 0.65 is from NCV data
  ...
  # **ADAPTED**
  utility_undiagnosedCD_children <- (((asymp_prop/undiag_all)*((0.958+0.59)/2)+(symp_undiag/undiag_all)*0.59)+
                                                                ((asymp_prop/(undiag_all-p_diag_ever))*((0.958+0.59)/2)+(((symp_undiag-p_diag_ever)/(undiag_all-p_diag_ever))*0.59)))/2 # 0.59 is from NCV data
  ...
  cost_undiagnosedCD_adults <- (((((asymp_prop/undiag_all)*(cost_undiagnosedCD_adults_tmp*0.5)) +((symp_undiag/undiag_all)*cost_undiagnosedCD_adults_tmp)))+
                                        ((asymp_prop/(undiag_all-p_diag_ever))*(cost_undiagnosedCD_adults_tmp*0.5)+(((symp_undiag-p_diag_ever)/(undiag_all-p_diag_ever))*cost_undiagnosedCD_adults_tmp)))/2 
  ...
  cost_undiagnosedCD_children <- (((((asymp_prop/undiag_all)*(cost_undiagnosedCD_children_tmp*0.5)) +((symp_undiag/undiag_all)*cost_undiagnosedCD_children_tmp)))+
                                          ((asymp_prop/(undiag_all-p_diag_ever))*(cost_undiagnosedCD_children_tmp*0.5)+(((symp_undiag-p_diag_ever)/(undiag_all-p_diag_ever))*cost_undiagnosedCD_children_tmp)))/2 
  ...
  # **ADAPTED**
  cost_abs_undiagnosed_fc <-  ((((asymp_prop/undiag_all)*(1674.54*0.5)+(symp_undiag/undiag_all)*1674.54))+
                                      ((asymp_prop/(undiag_all-p_diag_ever))*(1674.54*0.5)+(((symp_undiag-p_diag_ever)/(undiag_all-p_diag_ever))*1674.54)))/2  #WAS: 1674.54 #2021 eur 
