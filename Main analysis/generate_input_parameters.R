...
generate_input_parameters <- function(n_samples,
  ...
  probability_late_diagnosis_adults <- 1 - ((1-p_diag_ever)/(1-p_diag_children))^(1/35)  #the 35 is the result of calibrating in order to achieve the assumption that 1 in 3 people reach the diagnosed state throughout the model (checked using the markov trace).  
  ...
  utility_undiagnosedCD_se_adults <-  0.01 
  ...
  utility_undiagnosedCD_se_children <-   0.02 
