...
# NOTE: ----------  Main script for Scenario Analysis  ----------------
...
# That is why each strategy has a different 'generate_input_parameters' function, each of which implements weighting to align with the assumptions of the scenario.
...
set.seed(14143)
#to ensure consistency in sampled values across runs
